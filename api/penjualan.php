...
switch ($method) {
    case 'GET':
        ...
        // data penjualan
        $sql = "SELECT p.id_penjualan, p.jumlah_penjualan, p.status, p.created_at, u.username as nama_user
                FROM penjualan p
        ...
        if ($action === 'detail') {
            ...
            if (isset($query_data['id_penjualan'])) {
                ...
                $sql = "SELECT dp.id_detail_penjualan, dp.id_produk, p.nama_product, dp.jumlah_penjualan, dp.harga_penjualan
    ...
    case 'POST':
        ...
        $sql = "INSERT INTO penjualan (id_user, jumlah_penjualan, status, created_by, created_at) VALUES ($id_user, $jumlah_penjualan, 'Y', $id_user, NOW())";
